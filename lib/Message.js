...
const parser = PEG.buildParser(fs.readFileSync(path.join(__dirname, 'message.peg'), 'utf8'));
...
module.exports = class Message {
    ...
    static stringify(o) {
        ...
        switch (o.command) {
            ...
            case 'FROM': return `${o.command} ${o.name} ${Message.stringify(o.msg)}`;
            ...
            case 'OK': return `${o.command} ${Message.stringify(o.msg)}`;
